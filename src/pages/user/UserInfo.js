...
import { Button, Card, Col, Container, Form, ListGroup, Offcanvas, Row, ProgressBar, OverlayTrigger, Tooltip, Image } from "react-bootstrap";
                    ...
                    <div className="vstack gap-4">
                        ...
                        <Card className="border">
                            <Card.Header className="border-bottom">
                                ...
                                <p className="mb-0">Your current email address is <span className="text-primary">example@gmail.com</span></p>
                            </Card.Header>
                            <Card.Body>
                                <Form>
                                    <Form.Label>Enter your new email id
